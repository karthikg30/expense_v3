    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cby', models.CharField(blank=True, default='app_user', max_length=25, null=True)),
                ('mby', models.CharField(blank=True, max_length=25, null=True)),
                ('cat_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='expense_app.cat_master')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='expense_app.cat_master')),
                ('sub_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='expense_app.sub_cat')),
            ],
        ),
    ]
